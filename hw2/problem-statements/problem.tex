...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 2}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 2}
...
%\tableofcontents
%\vspace*{8mm}
% \problem{A1}{Divisibility (Easy Version)}{1}{2048}
% \problem{A2}{Divisibility (Hard Version)}{1}{2048}
% \problem{B1}{Sum of Pairs (Easy Version)}{1}{2048}
\problem{B2}{Sum of Pairs (Hard Version)}{1}{2048}
\end{document}
