...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Homework 0}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Homework 0}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{A + B Problem}{1}{2048}
\problem{B}{A Sorting Problem}{1}{2048}
\problem{C}{Exponentiation}{1}{2048}
\end{document}
