...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 6}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 6}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{Make It Connected}{2}{2048}
% \problem{B}{Shortest Paths with Negative Weights}{1}{2048}
% \problem{C}{Subgraph Selection}{1}{2048}
\end{document}
