...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 5}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 5}
...
%\tableofcontents
%\vspace*{8mm}
% \problem{A}{Maximum Sum Path on DAG}{1}{2048}
\problem{B}{Dynamic Graph Queries}{2}{2048}
% \problem{C}{Isolated Verticies}{1}{2048}
\end{document}
