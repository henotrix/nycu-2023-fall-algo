...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Final Exam}
...
{
	\fancyhf{}
	% \fancyhead[C]{\includegraphics[width=1\textwidth]{image/header.png}\\Introduction to Algorithms, Fall, 2023\\Homework 0}
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Final Exam}
	%\fancyhead[R]{International Collegiate Programming Contest\\[1mm]Taiwan Online Programming Contest\vspace{1mm}}
    \fancyfoot[C]{\thepage}
}
\pagestyle{document}
...
{
	\stepcounter{ncase}
	\IfFileExists{../#1/data/sample/0-0\arabic{ncase}.in}
    {
		\vspace{-1mm}
		%\begin{paracol}{2}
			\subsection*{Sample Input \arabic{ncase}}
            \begin{minipage}{\linewidth}
                \lstinputlisting{../#1/data/sample/0-0\arabic{ncase}.in}
            \end{minipage}
			%\switchcolumn
			\subsection*{Sample Output \arabic{ncase}}
            \begin{minipage}{\linewidth}
                \lstinputlisting{../#1/data/sample/0-0\arabic{ncase}.ans}
            \end{minipage}
		%\end{paracol}
		\testdata{#1}
    }{}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{Maximum Subarray Sum Revisited}{1}{2048}
% \problem{B}{Connected Component Queries}{1}{2048}
% \problem{C}{Tree Diameter}{1}{2048}
% \problem{D}{Maximum Weighted Independent Set in Trees}{1}{2048}
% \problem{E}{Shortest Paths}{2}{2048}
% \problem{F}{Maximum Subset Sum}{1}{2048}
\end{document}
