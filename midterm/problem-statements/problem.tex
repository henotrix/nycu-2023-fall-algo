...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Midterm Exam}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Midterm Exam}
...
%\tableofcontents
%\vspace*{8mm}
% \problem{A}{Rearrangement}{1}{2048}
% \problem{B}{Divisibility 2}{1}{2048}
% \problem{C}{Counting Inversions}{1}{2048}
% \problem{D}{Maximum Sum Path 2}{1}{2048}
% \problem{E}{Range Maximum Queries}{2}{2048}
\problem{F}{Competition}{2}{2048}
\end{document}
