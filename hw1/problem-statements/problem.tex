...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 1}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 1}
...
%\tableofcontents
%\vspace*{8mm}
\problem{B}{Range Order Statistic Queries}{3}{2048}
\end{document}
