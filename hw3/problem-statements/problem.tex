...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 3}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 3}
...
%\tableofcontents
%\vspace*{8mm}
% \problem{A1}{Increasing Matrix (Easy Version)}{2}{2048}
\problem{A2}{Increasing Matrix (Hard Version)}{2}{2048}
% \problem{B1}{Dynamic Order Statistic Queries (Easy Version)}{1}{2048}
% \problem{B2}{Dynamic Order Statistic Queries (Hard Version)}{1}{2048}
\end{document}
