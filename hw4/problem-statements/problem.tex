...
\usepackage{titling}
\title{Introduction to Algorithms, Fall, 2023\\Programming Homework 4}
...
\fancypagestyle{document}
{
	...
	\fancyhead[C]{Introduction to Algorithms, Fall, 2023\\Programming Homework 4}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{Points and Intervals}{1}{2048}
% \problem{B}{Maximum Sum Path}{1}{2048}
% \problem{C}{Rod Cutting}{1}{2048}
\end{document}
